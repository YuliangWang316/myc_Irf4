...
pbmc <- subset(pbmc, subset = nFeature_RNA > 200 & nFeature_RNA < 6000 & percent.mt < 45)
...
remove(pbmcs)
pbmc <- FindNeighbors(pbmc, dims = 1:5, verbose=F)
pbmc <- FindClusters(pbmc, resolution = 0.7, verbose=F)
