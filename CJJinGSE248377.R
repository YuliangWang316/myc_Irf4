...
ref<-merge(ref1, y = c(ref3, ref4,ref5,ref6,ref7), add.cell.ids = c("ref1", "ref3", "ref4","ref5","ref6","ref7"), project = "Total")
...
ref_new_new<-subset(ref_new,idents = c("DZd","DZp" ,"LZ3", "LZ2", "LZ1"))
pbmc2.metadata<-pbmc2@meta.data
...
remove(pbmc2.metadata,pbmc2.data,pbmc2)
gc()
...
remove(all.genes)
new.cluster.ids <- c("LZ","DZ","prePB","PC","LZ","DZ","LZ","DZ","LZ","LZ")
...
saveRDS(ref_new,"e:/CJJGSE248377_new.rds")
...
write.table(diff_test_res,"diff_Test_res_CJJGSE248377.txt",sep = "\t",row.names = FALSE,quote = FALSE)
...
saveRDS(monocle_cds,"e:/CJJGSE243877_monocle.rds")
