...
#features_1<-c("Myc","Irf4","Kdm6b","Ly75","Mtor_1","Mtor_2","Mtor_3","Glutamine_1")
features_2<-c("Myc","Irf4","Ly75")
DotPlot(pbmc,features = features_2)
features_3<-c("Mtor_1","Mtor_2","Mtor_3","Glutamine_1")
DotPlot(pbmc,features =features_3)
features_4<-c("Kdm6b","Kdm6a","Ezh2")
DotPlot(pbmc,features = features_4)
features_5<-c("Ly75","Cd274","Cd86","Cd83","Cd82","Cd81","Cd80","Cd40")
DotPlot(pbmc,features = features_5)
DoHeatmap(pbmc,features = features_5)
