...
pbmc <- ScaleData(pbmc, features = all.genes, verbose=F,vars.to.regress = c("percent.mt","nFeature_RNA"))
...
FeaturePlot(pbmc,features =c("Irf4"),order = TRUE,cols = c("lightgrey", "Blue"),reduction = "lda3umap",min.cutoff = "q10",max.cutoff = "q90")
FeaturePlot(pbmc,features =c("Kdm6b"),order = TRUE,cols = c("lightgrey", "Blue"),reduction = "lda3umap",min.cutoff = "q10",max.cutoff = "q90")
...
FeaturePlot(pbmc,features =c("Ly75"),order = TRUE,cols = c("lightgrey", "Blue"),reduction = "lda4umap",min.cutoff = "q25",max.cutoff = "q75")
...
FeaturePlot(pbmc,features =c("Irf4"),cols = c("lightgrey", "Blue"),reduction = "lda4umap",min.cutoff = "q25",max.cutoff = "q75")
FeaturePlot(pbmc,features =c("Kdm6b"),cols = c("lightgrey", "Blue"),reduction = "lda4umap",min.cutoff = "q25",max.cutoff = "q75")
FeaturePlot(pbmc,features =c("Ly75"),cols = c("lightgrey", "Blue"),reduction = "lda4umap",min.cutoff = "q25",max.cutoff = "q75")
...
DotPlot(pbmc,features =c("Irf4","Gls","Kdm6b","Ly75"),scale = TRUE,col.min = 0,col.max = 800)
...
remove(ref)
gc()
saveRDS(pbmc,"d:/CJJGSE109732-2.rds")
...
gc()
saveRDS(pbmc,"d:/CJJGSE109732-2_cellcycle.rds")

library(sctransform)
pbmc <- SCTransform(pbmc, verbose = FALSE)
gc()
saveRDS(pbmc,"d:/CJJGSE109732-2_cellcycle_sctransform.rds")
