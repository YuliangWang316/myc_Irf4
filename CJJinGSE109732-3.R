...
pbmc <- ScaleData(pbmc, features = all.genes, verbose=F,vars.to.regress = c("nFeature_RNA"))
...
remove(ref)
gc()
saveRDS(pbmc,"d:/CJJGSE109732-3.rds")
...
gc()
saveRDS(pbmc,"d:/CJJGSE109732-3_cellcycle.rds")
library(sctransform)
pbmc <- SCTransform(pbmc, verbose = FALSE)
gc()
saveRDS(pbmc,"d:/CJJGSE109732-3_cellcycle_sctransform.rds")
